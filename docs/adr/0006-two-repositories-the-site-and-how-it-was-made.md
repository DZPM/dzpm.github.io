...
- The private repository is hosted on GitHub as a private repository, with the same data that lived for thirteen years on a rented server and today lives in a synced folder; private hosting does not worsen that, and it keeps a history. It carries a warning at the top of its README, and is never forked or made public. (GitHub's secret scanning and push protection are not offered for private repositories on this account's plan.)
